---
title: Notion Node
description: The Notion Node automates content management and page operations with Notion workspaces, enabling both trigger-based workflows and action-based operations for comprehensive Notion integration.
type: Apps
order: 11
---
...
<NodeOverview slug="notion-node" type="apps" />
...
<NodeTypeInfo
  ...
  eventTrigger={true}
  action={true}
  description="This node supports both Event Trigger and Action modes for comprehensive Notion integration."
/>
