...
> **Note**: Make sure Config B uses a different node or configuration that's more reliable or faster, even if potentially less optimal.
...
> **Warning**: Be careful to avoid infinite loops. Ensure your conditions can eventually be false, or set maximum iteration limits.
...
- [Model Logic](/docs/models/model-logic) - Learn about logic options for model nodes
