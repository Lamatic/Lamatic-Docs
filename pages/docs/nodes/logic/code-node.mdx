---
title: Code Node
description: The Lamatic.ai JavaScript Code Node empowers users to integrate custom logic seamlessly into their flow.
type: Logic
order: 1
---
