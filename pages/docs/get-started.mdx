...
Create your first project and start building your first workflow.
...
Add Apps and Data Sources to your project to connect with your workflows.
...
<details>
    <summary>Paste the below code in your workflow config.</summary>
...
### Test and Deploy
    Test your workflow by adding a custom payload based on your schema.
    ![Test](/public/quickstart/test.png)
    When ready hit the deploy button. This will compile the workflow and deploy it on the edge.
