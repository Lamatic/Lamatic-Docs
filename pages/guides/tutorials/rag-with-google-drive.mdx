---
description: RAG with Google Drive
title: 4. RAG with Google Drive
category: Beginner
---
...
1. Select the “Vectorize Google Drive” ([Template](https://hub.lamatic.ai/templates/google-drive-sync)) flow template under the Product Category and use this template
    ![flow.png](./img/rag-with-google-drive/google-drive.png)
1. You will have six nodes to configure: Google Drive (Trigger Node), Chunking, Extract Chunked Text, Get Vectors, Transform Metadata, and Index into DB.
    ![flow.png](./img/rag-with-google-drive/google-drive-config.png)
...
1. Click the plus icon to select the data and provide the text you want to chunk.
    ![flow.png](./img/rag-with-google-drive/data-chunk.png)
...
During vectorization, each chunk of text is transformed into a high-dimensional vector — essentially a long list of numbers that captures the semantic meaning of the text. This mathematical representation allows the AI to understand relationships between different pieces of information and find relevant content quickly.
