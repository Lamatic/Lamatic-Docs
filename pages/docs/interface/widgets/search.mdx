---
title: Search Widget
description: Embed Lamatic’s search widget on your site to deliver AI-powered, context-aware search results from your content.
---
...
### 3. Select an Ask flow to run
- **Field:** Ask flow (dropdown in search widget node config)
