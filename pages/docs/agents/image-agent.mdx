...
|---------------------------|----------------------------------------------------------|---------------------------------------|
| **Generative Model Name** | Selects the AI model for image generation.               | `DALL·E 3`                           |
| **Prompt Template**       | Defines text instructions for the generated image.       | `"Create an image of a futuristic city"` |
| **Image Resolution**      | Specifies the resolution of the output image.            | `1024x1024`                          |
| **Style & Detail Level**  | Controls artistic style and image detail intensity.      | `Photorealistic, HD`                 |
