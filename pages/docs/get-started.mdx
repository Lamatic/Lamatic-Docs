...
This guide helps you go from **zero → deployed Lamatic project** and test it end-to-end. Use UI-first with Studio approach or API-first: code and API calls approach.
...
- **Integrating from an app:** [API Overview](/docs/integrate-api-sdk/api-overview), [Authentication with API Keys](/docs/api-integration/api-key)
