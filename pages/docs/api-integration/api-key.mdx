...
If your application environment, API gateway, or webhook receiver uses IP-based access controls, review [IP Allowlisting](/docs/ips) to allow Lamatic traffic before moving to production.
