...
Your Vector Store schema can be defined automatically when you index the first object inside a Vector Store. You can construct a schema by adding various keys (e.g. Article, Product, etc.), properties/fields, and mapping values to automatically define data types.
