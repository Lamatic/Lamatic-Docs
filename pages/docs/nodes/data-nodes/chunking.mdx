...
Accurately chunked data ready to be embedded into a vector database. To get each the data of each Chunk, you will nead to extract `pageContent` object from the list. To do that you can use code node after the chunk node. 

#### Here is a sample JS code for that
```
