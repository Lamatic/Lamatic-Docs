...
description: At Lamatic, we believe in collaborating with the global security researcher community to enhance the security of our products.
---
...
1. **Products**
   - [Lamatic.ai Studio](https://studio.lamatic.ai/) - Web applications
   - APIs
   - Cloud services
...
<iframe class="airtable-embed" src="https://airtable.com/embed/app7b9wDyU73T6rN2/pagebdjvwRvjRUGjG/form" width="100%" height="800"></iframe>

## Response Times

<Callout type="warning" >
  We are experiencing a high volume of vulnerabilities, which may result in longer processing times than usual
</Callout>
...
2. Severity assessment: **15 business days**
...
| **2. Initial Assessment**          | - Validate the authenticity of the issue. <br/> - Perform a **Duplicate Check** to ensure the bug hasn’t been previously reported. <br/> - Share an NDA if necessary.                                                                  |
| **3. Severity Analysis**           | Assess the severity using a standard rating system such as **CVSS**: <br/> - **Critical**: Immediate, widespread impact (e.g., RCE, data breaches). <br/> - **High**: Significant functionality or security risks. <br/> - **Medium**: Moderate impact. <br/> - **Low**: Minor risks. |
