# Hybrid Search Node
<NodeOverview slug="hybrid-search-node" type="data" />
...
<NodeTypeInfo 
  ...
  eventTrigger={false}
  action={true}
  description="This node is an **Action** node that performs hybrid search operations combining multiple search strategies to retrieve relevant data."
/>
...
| **Certainty**                           | It's the distance score into a value between 0 &lt;= certainty &lt;= 1, where 1 would represent identical vectors and 0 would represent opposite vectors.                                                                   | 0.7                          |
