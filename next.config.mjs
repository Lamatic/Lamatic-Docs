...
const nonPermanentRedirects = [
  ...
  ["/docs/partners", "/company/partners"],
  ["/docs/brandkit", "/company/brandkit"],
  ["/docs/career", "/company/career"],
  ["/docs/hacktoberfest", "/company/hacktoberfest"],
  ["/docs/report-issue", "/docs/security/anonymous-reporting"],
  ["/docs/vulnerability-disclosure", "/docs/security/vulnerability-disclosure"],
  ["/company/report-issue", "/docs/security/anonymous-reporting"],
  ["/company/vulnerability-disclosure", "/docs/security/vulnerability-disclosure"],
...
const permanentRedirects = [
  // Redirects for restructured paths (main branch → current)
  ["/docs/ai-middleware", "/docs/concepts/ai-middleware"],
  ["/docs/ai-middleware/architecture", "/docs/architecture"],
  ["/docs/concepts/ai-middleware/architecture", "/docs/architecture"],
  ["/docs/studio-keys", "/docs/studio/studio-keys"],
  ["/docs/studio-overview", "/docs/studio/studio-overview"],
  ["/docs/studio-project", "/docs/studio/studio-project"],
  ["/docs/studio-role-based-access", "/docs/studio/studio-role-based-access"],
  ["/docs/studio-tags", "/docs/studio/studio-tags"],
  ["/docs/studio-variables-and-secrets", "/docs/studio/studio-variables-and-secrets"],
  ["/docs/studio/project", "/docs/studio/studio-project"],
  // Old "/docs/concepts/studio/*" paths are indexed externally (e.g. blog backlinks) but never existed as real pages
  ["/docs/concepts/studio/studio-keys", "/docs/studio/studio-keys"],
  ["/docs/concepts/studio/studio-overview", "/docs/studio/studio-overview"],
  ["/docs/concepts/studio/studio-project", "/docs/studio/studio-project"],
  ["/docs/concepts/studio/studio-role-based-access", "/docs/studio/studio-role-based-access"],
  ["/docs/concepts/studio/studio-tags", "/docs/studio/studio-tags"],
  ["/docs/concepts/studio/studio-variables-and-secrets", "/docs/studio/studio-variables-and-secrets"],
  // "nodes" was pluralized in the URL structure; old links still point at the singular form
  ["/docs/node-logic", "/docs/nodes/node-logic"],
  ["/docs/node-assistant", "/docs/nodes/node-assistant"],
  ["/docs/nodes/models/model-logic", "/docs/models/model-logic"],
  // n8n Migration doc was removed; send old links to the current n8n integration doc
  ["/docs/n8n-migration", "/integrations/apps-data-sources/n8n"],
...
["/docs/integrations/apps/websearch","/integrations/apps-data-sources/websearch"],
...
["/docs/integrations/Data/Google_Drive","/integrations/apps-data-sources/google-drive"],
...
["/docs/workflows/Nodes/Flow/search-web","/integrations/apps-data-sources/websearch"],
["/docs/studio/Workspace/Settings","/docs/studio/studio-overview"],
["/docs/deployments/versions","/docs/deployments"],
["/docs/Trash/jobs/history","/docs/jobs"],
["/docs/flows/Nodes/Flow/search-web","/integrations/apps-data-sources/websearch"],
...
["/docs/studio/Account","/docs/studio/studio-overview"],
...
["/docs/integrations/Apps/Slack","/integrations/apps-data-sources/slack"],
["/docs/studio/Project/Settings","/docs/studio/studio-project"],
...
["/docs/nodes/flow/search-web","/integrations/apps-data-sources/websearch"],
...
["/docs/IDE/2._Code_IDE","/docs/ide/code-ide"],
...
["/docs/studio/Account/Settings/API","/docs/studio/studio-project"],
["/docs/workflows/execution-logs","/docs/logs"],
["/docs/studio/Project/Settings/API","/docs/studio/studio-project"],
...
["/docs/studio/Account/Settings","/docs/studio/studio-overview"],
["/docs/workflows/Nodes/Flow/followup","/docs/flows/nodes"],
...
["/docs/models/model-credentials","/docs/models"],
["/docs/integrations/Developer/posthog","/docs/studio/studio-project"],
["/docs/IDE/Code IDE","/docs/ide/code-ide"],
["/docs/flows/Nodes/Flow/query-database","/docs/flows/nodes"],
["/docs/organization/roles","/docs/studio/studio-overview"],
["/docs/workflows/Nodes/Apps","/docs/flows/nodes"],
["/docs/nodes/flow/followup","/docs/flows/nodes"],
["/docs/experiments/Test Suites","/docs/studio/studio-project"],
["/docs/integrations/Developer/langfuse","/docs/studio/studio-project"],
...
["/docs/studio/Project/Settings/Developer","/docs/studio/studio-project"],
...
["/docs/workflows/Nodes/Flow/code","/docs/flows/nodes"],
["/docs/workflows/nodes/Logic/search-web","/integrations/apps-data-sources/websearch"],
...
["/docs/posthog","/docs/studio/studio-project"],
...
["/docs/workflows/Nodes/AI/RAG","/docs/flows/nodes"],
["/docs/models/usage-cost","/docs/models/benchmark"],
["/docs/apps/marketplace","/integrations"],
...
["/docs/studio/Project/Settings/keys","/docs/concepts/studio/studio-project#api-keys"],
...
["/docs/bug-bounty-program","/docs/security/vulnerability-disclosure"],
...
["/docs/nodes/vector-search-node","/docs/nodes/data/vectordb-node"],
["/docs/integrations/Credentials","/integrations/adding-integration"],
["/docs/mcp/tools","/docs/mcp/mcp-node"],
...
["/docs/integrations/firecrawl","/integrations/apps-data-sources/firecrawl"],
["/docs/test","/docs/tests/flow-testing"],
["/docs/Trash/logs/Retry","/docs/nodes/node-logic"],
...
["/docs/studio/role-based-functionalities","/docs/studio/studio-role-based-access"],
...
["/docs/studio/Workspace/Roles","/docs/studio/studio-role-based-access"],
...
["/docs/keys","/docs/studio/studio-keys"],
["/docs/studio","/docs/studio/studio-overview"],
...
["/docs/organization/overview","/docs/studio/studio-overview"],
...
["/careers/jobs","/company/career"],
["/docs/IDE/1._Prompt_IDE","/docs/ide/prompt-ide"],
["/docs/studio/Workspace","/docs/studio/studio-overview"],
["/start","/"],
...
["/docs/mcp/mcp","/docs/mcp/mcp-node"],
...
const rewrites = [
  ...
  ["/assets/:path*", "https://landing.lamatic.ai/assets/:path*"],
