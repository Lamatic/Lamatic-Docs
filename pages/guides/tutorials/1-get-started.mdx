...
Flows are the main components of Lamatic, allowing you to link different modules (or nodes) together in a sequence to achieve your goals. This guide explains how to understand and simply create flows in Lamatic.
