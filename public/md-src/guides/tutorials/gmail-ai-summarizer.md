...
<div className="mt-4 mb-4">
  This use case can be implemented with Gmail and N8N integrations. We’re covering **Gmail integration** here; for **N8N integration**, see [AI Email Summarizer](/guides/tutorials/ai-email-summarizer).
</div>
