---
title: Multimodal Node
description: The Multimodal Node allows users to process multiple types of data (text, images, audio) using AI models in a single workflow.
type: AI
order: 5
---
