...
description: The Classifier Node categorizes and routes input data based on predefined classification criteria
type: AI
order: 4
---
...
The Classifier Node processes input data and classifies it into predefined categories. This node is essential for applications requiring automated data categorization, intent recognition, or routing tasks based on classification results.

![agentc.png](../img/agentc/agent-classifier.png)
