...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=get-started" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=get-started" target="_blank">Add to Lamatic</a>
  </Button>
</div>
...
1. Set up your prompt:
   - In the Prompt Template, write: `Give me insight on topic: {{triggerNode_1.output.topic}}`
