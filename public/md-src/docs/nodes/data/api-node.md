...
<NodeOverview slug="api-node" type="data" />
...
<NodeTypeInfo
  ...
  eventTrigger={false}
  action={true}
  description="This node is an Action node that makes HTTP requests to external APIs and retrieves data for processing in workflows."
/>
...
| **Convert XML Response to JSON** | Automatically convert XML responses to JSON format.                                               | No           | true                         |
