...
Integrate our powerful vector search widget into your website using the search nodes. This widget leverages vector search technology to provide more accurate and relevant search results by understanding the context and meaning of the queries rather than just matching keywords. Now, you can offer this advanced search functionality directly on your site.

<img src="/assets/search-node-sample.png" alt="Search Widget Example" />

## How Vector Search Works

Vector search works by converting both search queries and content into vectors—multi-dimensional representations that capture the meaning and context of the text. By comparing these vectors, the search engine can identify and retrieve content that is semantically similar to the query, offering more accurate and contextually relevant results.
...
Below is the documentation for the props used in the vector search widget configuration:
