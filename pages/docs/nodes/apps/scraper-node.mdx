...
<details>
  <summary>**Key Functionalities**</summary> 
    ...
    3. **Agent Workflows**: Submit and monitor agent tasks with three modes - Async Agent, Sync Agent, and Check Agent for intelligent web data extraction.
    
    4. **TLS Verification**: Includes an option to skip TLS verification, enabling compatibility with a wider range of websites. 
    
    5. **Device Emulation**: Offers the ability to emulate mobile devices, ensuring accurate scraping of mobile-optimized pages. 
    
    6. **Adjustable Load Timing**: Allows users to set a custom wait time (in milliseconds) for pages to load, accommodating different website performance speeds.
</details> 
