...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=firecrawl-scrapping" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=firecrawl-scrapping" target="_blank">Add to Lamatic</a>
  </Button>
</Callout>
</div>
...
<div className="mt-4 mb-4">
  <Callout>
  Try out this flow yourself at Lamatic.ai. Sign up for free and start building your own AI workflows.
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=firecrawl-webhook" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=firecrawl-webhook" target="_blank">Add to Lamatic</a>
  </Button>
</Callout>
</div>
...
<div className="mt-4 mb-4">
  <Callout>
  Try out this flow yourself at Lamatic.ai. Sign up for free and start building your own AI workflows.
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=document-chatbot-widget" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=document-chatbot-widget" target="_blank">Add to Lamatic</a>
  </Button>
</Callout>
</div>
