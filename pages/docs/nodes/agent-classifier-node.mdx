...
- _meta: A nested object containing metadata about the request processing.
...
- class: The classification label or result determined by the classifier.
 
- condition: A secondary attribute indicating the condition or context of the classification.
