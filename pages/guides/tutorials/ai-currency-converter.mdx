...
1. Add Tool name: convertINRtoUSD
   ![flow.png](./img/ai-currency-converter/update-tool.png)
...
3. You can test the JavaScript Code by providing parameters and clicking on the Test button.
   ![flow.png](./img/ai-currency-converter/edit-tool.png)
...
1. Click the API response node.
   ![Flow Deploy](./img/ai-currency-converter/flow-api-schema.png)
