...
![Flow.png](./build-first-flow/flow-assets/img/flow.png)
...
![Flow.png](./build-first-flow/flow-assets/img/flow-action.png)
...
See: [Flow Editor](/docs/build-first-flow/flow-editor) and [Testing](/docs/build-first-flow/tests)

## Share Flow
![Flow.png](./build-first-flow/flow-assets/img/share-flow.png)
...
- Learn about deployment: [Deployments](/docs/deploy-section/deployments)