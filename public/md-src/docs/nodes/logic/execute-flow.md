...
<NodeOverview slug="execute-flow" type="logic" />
...
<NodeTypeInfo 
  ...
  eventTrigger={false}
  action={true}
  description="This node is an **Action** node that executes other workflows from within the current workflow for modular workflow design."
/>
