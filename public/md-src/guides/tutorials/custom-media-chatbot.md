...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=custom-media-chatbot" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=custom-media-chatbot" target="_blank">Add to Lamatic</a>
  </Button>
</div>
...
![Document Chatbot](./img/custom-media-chatbot/custom-media-chatbot.webp)
...
![Chat Widget](./img/custom-media-chatbot/chat_v2.webp)
2. You will be choosing the allowed domains for the chatbot widget to be embedded in or use wildcard (*) to allow all domains.
3. Along with that, you can customise the appearance of the widget, including the color, position, and other settings.
  ![Chat Widget](./img/custom-media-chatbot/chat_config_1.webp)
  ![Chat Widget](./img/custom-media-chatbot/chat_config_2.webp)
  ![Chat Widget](./img/custom-media-chatbot/chat_config_3.webp)

### 3. Extract File Node
1. Add the "Extract File" node to your flow.
![Chat Widget](./img/custom-media-chatbot/chat-extract-download.png)
...
![Chat Widget](./img/custom-media-chatbot/code-chat.png)
2. Write the following script to extract the text from the file content:
```js
output = {{ extractFromFileNode_959.output.files }}[0]["data"][0]
```
...
![Chat Widget](./img/custom-media-chatbot/code-chat-gen.png)
