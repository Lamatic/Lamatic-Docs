...
<div className="mt-4 mb-4">
  This use case can be implemented with Gmail and N8N integrations. We’re covering **N8N integration** here; for **Gmail integration**, see [Gmail AI Summarizer](/guides/tutorials/gmail-ai-summarizer).
</div>
