...
- [Test](/docs/tests) \- Tools to test and debug your flow and application in development and before Deployments.
...
- [Hub ↗](https://hub.lamatic.ai) \- Perfect your workflow with powerful apps, models and templates. Any workflow is possible with a boost from the app marketplace..
...
- [Widgets](/docs/interface/Widgets/Chat) \- Drop In AI Components like Search and Chat in your application with few lines of code.
...
- [Edge Deployments](/docs/deployments) \- Deploy and manage your agents and workflows on the Edge.
