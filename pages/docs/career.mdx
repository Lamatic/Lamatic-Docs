...
<Accordion>
    ...
    <AccordionItem key="3" aria-label="AI/UX/UI Designer" title="AI/UX/UI Designer">

      ### **AI/UX/UI Designer – Founding Role**
    ...
    <AccordionItem key="4" aria-label="Developer Relations Engineer" title="Developer Relations Engineer">
    ...
    <AccordionItem key="5" aria-label="Support Engineer" title="Support Engineer">
