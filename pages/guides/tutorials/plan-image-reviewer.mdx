...
title: Automated Plant Identification and Care Data Extraction from Images
category: Beginner
order: 8
thumbnail: /images/tutorials/ai-image-reviewer.png
---

# Automated Product Identification and Data Extraction from Images
...
2. Choose "Text Generator"
   ![Node Text Gen](./img/plant-image-reviewer/text-gen-node1.png)
...
- You can add variables using the "Add Variable" button
  ![Node Text Gen Config](./img/plant-image-reviewer/text-gen-node2.png)
