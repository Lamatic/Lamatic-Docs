...
<IntegrationOverviw slug="onedrive" type="apps-data-sources" />
...
### Event Triggers
✅ Scheduled document syncing from OneDrive drives <br/>
...
1. **Test Connection**: Verify the node can access your OneDrive account
...
2. **Check Drive Access**: Ensure you can access the OneDrive drive in your browser
