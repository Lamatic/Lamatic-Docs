...
<details>
  ...
  accuracy and contextual understanding. 6. **Enhanced Classifier Editor:** Two-field editor (Name + Description) for better clarity, with inline editing enabled for both fields, making quick updates seamless.
</details>
...
| **Classifier**            | Add Classifier with optional description. The two-field editor (Name + Description) supports inline editing for both fields, enabling quick and seamless updates. | `Classifier 1`               |
| **System Prompt**         | System prompt to guide the LLM                                                                                 | You are Travel Planner       |

### Classifier Editor

Classifier nodes now support optional descriptions alongside names. The enhanced two-field editor provides:

- **Name Field:** The classifier label used for identification and routing
- **Description Field (Optional):** Additional context or details about the classifier
- **Inline Editing:** Both fields support inline editing, allowing you to make quick updates directly in the editor without opening additional dialogs
