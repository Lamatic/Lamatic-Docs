...
const rewrites = [
    ...
    ["/:path((?!docs|blog|guides|integrations|agentkits|templates|_next|public|assets|images|api|robots.txt|sitemap-0.xml|ambassadors|security).*)", "https://get.lamatic.ai/:path*"],
