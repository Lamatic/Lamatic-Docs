...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=get-started-with-google-sheet" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=get-started-with-google-sheet" target="_blank">Add to Lamatic</a>
  </Button>
</div>
