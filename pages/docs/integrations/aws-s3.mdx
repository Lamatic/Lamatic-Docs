...
![s3](./img/s3.png)
    ...
    - `hi_res` is the most reliable, but requires an API key and a hosted instance of unstructured and can't be used with local mode.
...
```js
{
  "triggerNode": {
    ...
    "values": {
      ...
      "bucket": "new-testing-12345",
      "credentials": "{your-aws-credentials}",
      "syncSchedule": "Every 24 hours",
      "pathPatterns": "**/*.csv"
    }
  }
}
