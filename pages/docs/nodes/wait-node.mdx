---
title: Wait Node
description: The Lamatic.ai Wait Node allows you to wait for a specified duration (0–90 seconds) during flow execution.
type: Logic
order: 9
---
...
The Lamatic.ai Wait Node allows you to introduce a controlled wait during your flow execution for a duration between 0 and 90 seconds. This is ideal for handling rate limits, sequencing actions, or waiting between dependent steps.
...
2. Set the **Wait Time (in seconds)** between 0 and 90.
...
| ------------------- | ----------------------------------------------------- | ------------ | ----------------- |
| **Wait Time (sec)** | Time in seconds to wait before proceeding (0–90 sec). | Yes          | 10                |
...
The Wait Node does not return any data. It simply waits for the configured duration before triggering the next node.
...
| **Problem**                    | **Solution**                                                 |
| ------------------------------ | ------------------------------------------------------------ |
| **Flow Not Continuing**                | Ensure the wait time is a number between 0 and 90 seconds.                                   |
