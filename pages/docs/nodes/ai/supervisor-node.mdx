...
description: The Supervisor Node monitors and manages the execution of other nodes in a workflow, providing oversight and control capabilities.
type: AI
order: 7
---
...
<NodeOverview slug="supervisor-node" type="ai"/>
...
<NodeTypeInfo 
  ...
  eventTrigger={false}
  action={true}
  description="This node is an Action node that monitors and manages workflow execution while providing oversight and control capabilities."
/>
