...
## **Vector Store powered by Weaviate**
...
2. Click on Add New Store button
3. Select Vector Store and Provide name of the Store
4. Click on the Create Button to create new Vector Store
...
To access the Vector Explorer, navigate through the following path: Context > Vector Store > [Vector Store]. Here, you'll find a user-friendly interface that displays all the vector objects you've created. This centralized view makes it easy to manage and analyze your vector data efficiently.
