...
<NodeOverview slug="vectorize-node" type="data" />
...
<NodeTypeInfo 
  ...
  eventTrigger={false}
  action={true}
  description="This node is an **Action** node that converts text data into vector embeddings for semantic processing and AI applications."
/>
...
1. **Streamlined Integration:** Easily incorporate vectorized data into downstream applications and flow.
