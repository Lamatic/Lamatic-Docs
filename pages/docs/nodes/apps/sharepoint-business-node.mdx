...
2. **Verify Permissions**:
   - Ensure you have appropriate SharePoint access permissions
   - Test access to the target SharePoint sites and folders
...
| --------------------- | --------------------------------------------------- | --------------------------- |
| **Credential Name**   | Name to identify this set of credentials            | `my-sharepoint-creds`       |
| **Microsoft 365**     | Microsoft 365 credentials with SharePoint access   | `Microsoft 365`             |
