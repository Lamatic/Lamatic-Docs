...
Click the + icon at the top right of each prompt type section to save it as a prompt template. 
This allows you to easily reuse it across other flows.
