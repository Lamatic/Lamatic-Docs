...
const permanentRedirects = [
    ...
    // Integrations
    ['/docs/integrations/aws-s3', '/docs/integrations/apps-data-sources/aws-s3'],
    ['/docs/integrations/firecrawl', '/docs/integrations/apps-data-sources/firecrawl'],
    ['/docs/integrations/github', '/docs/integrations/apps-data-sources/github'],
    ['/docs/integrations/google-drive', '/docs/integrations/apps-data-sources/google-drive'],
    ['/docs/integrations/google-sheets', '/docs/integrations/apps-data-sources/google-sheets'],
    ['/docs/integrations/teams', '/docs/integrations/apps-data-sources/teams'],
    ['/docs/integrations/n8n', '/docs/integrations/apps-data-sources/n8n'],
    ['/docs/integrations/onedrive', '/docs/integrations/apps-data-sources/onedrive'],
    ['/docs/integrations/postgres', '/docs/integrations/apps-data-sources/postgres'],
    ['/docs/integrations/sharepoint', '/docs/integrations/apps-data-sources/sharepoint'],
    ['/docs/integrations/slack', '/docs/integrations/apps-data-sources/slack'],
    ['/docs/integrations/onedrive', '/docs/integrations/apps-data-sources/onedrive'],
    ['/docs/integrations/websearch', '/docs/integrations/apps-data-sources/websearch'],

    // Models Integrations
    ['/docs/models/providers/bedrock', '/docs/integrations/models/bedrock'],
    ['/docs/models/providers/anthropic', '/docs/integrations/models/anthropic'],
    ['/docs/models/providers/azure-ai-foundry', '/docs/integrations/models/azure-ai-foundry'],
    ['/docs/models/providers/azure-openai', '/docs/integrations/models/azure-openai'],
    ['/docs/models/providers/cloudflare', '/docs/integrations/models/cloudflare'],
    ['/docs/models/providers/cohere', '/docs/integrations/models/cohere'],
    ['/docs/models/providers/deepinfra', '/docs/integrations/models/deepinfra'],
    ['/docs/models/providers/deepseek', '/docs/integrations/models/deepseek'],
    ['/docs/models/providers/fireworks-ai', '/docs/integrations/models/fireworks-ai'],
    ['/docs/models/providers/gemini', '/docs/integrations/models/gemini'],
    ['/docs/models/providers/groq', '/docs/integrations/models/groq'],
    ['/docs/models/providers/huggingface', '/docs/integrations/models/huggingface'],
    ['/docs/models/providers/ibm-watsonx-ai', '/docs/integrations/models/ibm-watsonx-ai'],
    ['/docs/models/providers/mistral-ai', '/docs/integrations/models/mistral-ai'],
    ['/docs/models/providers/ollama', '/docs/integrations/models/ollama'],
    ['/docs/models/providers/open-ai', '/docs/integrations/models/open-ai'],
    ['/docs/models/providers/perplexity-ai', '/docs/integrations/models/perplexity-ai'],
    ['/docs/models/providers/together-ai', '/docs/integrations/models/together-ai'],
    ['/docs/models/providers/voyage-ai', '/docs/integrations/models/voyage-ai'],
    ['/docs/models/providers/xai', '/docs/integrations/models/xai'],
]
