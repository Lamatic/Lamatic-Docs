...
<Tabs items={['Event Triggers', 'Actions']}>
<Tab>
...
<Tabs items={['Setup Credentials', 'Configure Node', 'Test Connection']}>
<Tab>
...
<Tabs items={['Node Parameters', 'Sync Options', 'File Filtering']}>
<Tab>
...
<Tabs items={['Basic Setup', 'Advanced Configuration', 'Selective Sync']}>
<Tab>
...
<Tabs items={['Common Issues', 'Debugging Steps', 'Best Practices']}>
<Tab>
