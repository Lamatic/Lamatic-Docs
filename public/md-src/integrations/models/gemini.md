...
<video controls loop width="100%" autoplay muted controlslist="nodownload" className="mt-4">
    <source src="/public/videos/models/gemini.mp4" type="video/mp4" />
...
- **Gemini Nano Banana**: AI image generator & editor — Generate images in Gemini, now with enhanced capabilities powered by Nano-Banana model
