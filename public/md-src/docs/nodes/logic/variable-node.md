...
<NodeOverview slug="variable-node" type="logic" />
...
<NodeTypeInfo 
  ...
  eventTrigger={false}
  action={true}
  description="This node is an **Action** node that defines and manages variables for data storage and manipulation within workflows."
/>
