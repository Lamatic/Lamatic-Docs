...
![hybrid.png](./img/hybrid/hybrid.png)
...
- searchResults: An array of objects, each representing a search result with its associated data and scoring information.

- _additional: A nested object containing supplementary metadata about the search result.
...
- score: A string representing the relevance or confidence score of the result, mirrored at the top level.
