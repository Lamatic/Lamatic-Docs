...
- [Tests](/docs/build-first-flow/tests) — Tools to test and debug your Flow and application in development and before deployments.
- [Version Control](/docs/deploy-section/version-control) — Manage versions and collaborate on your Flows.
- [Templates](/docs/templates) — Get started quickly with pre-built templates.

### Deploy
Deploy and manage your AI applications.

- [Deployments](/docs/deploy-section/deployments) — Deploy and manage your agents and Flows on the edge.
- [Jobs](/docs/deploy-section/jobs) — Monitor and configure scheduled processes.

### Optimize
Monitor, analyze and optimize your AI applications.

- [Logs](/docs/monitor-improve/logs) — See real-time request logs and traces.
- [Reports](/docs/monitor-improve/reports) — Analyze your projects with intuitive charts and queries.
...
<Cards num={3}>
    ...
    <Card href="/docs/integrate-api-sdk/api-overview" title="API Overview" arrow>
        {/*![API]()*/}
    </Card>
    <Card href="/docs/templates" title="Templates" arrow>
        {/*![Quickstart icon (rocket)]()*/}
    </Card>
</Cards>
