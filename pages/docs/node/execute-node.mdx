# Execute Node Documentation

The Execute Node in Lamatic enables execution of other flows within your current workflow, facilitating modular and reusable flow designs. This node serves as a powerful tool for creating complex, interconnected workflows by allowing flows to be used as building blocks.

---
![execute.png](./img/execute-node.png)
---
...
Before using the Flow Node, ensure you have:
