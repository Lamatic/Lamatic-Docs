...
![tools.png](./img/tools-overview.png)

Tools can be added in [**Generate Text Node**](/docs/nodes/ai/generate-text-node) and [**Multimodal Node**](/docs/nodes/ai/multimodal-node)
<br />
...
1. Navigate to Models > Tools Sections
1. Click on + Add Tool Button
1. Configure Tool by adding Name, Description, Parameters and Code
