...
![Prompt IDE interface showing prompt editor, AI assistant, and test output](./img/prompt-ide.png)

Use the **Prompt IDE** to design, test, and refine prompts for your LLM nodes in one place. You can configure the model, define role-based prompt blocks (such as **System** and **User**), and run quick tests to validate output before deploying your flow.

## Writing Prompts in Text editor

The Prompt IDE supports **Text formatting** and structured prompt authoring. You can:

- Insert dynamic variables with **Insert Variable**
- Use the built-in **AI Assistant** to generate and improve prompt content
- Test prompt behavior instantly from the test panel
