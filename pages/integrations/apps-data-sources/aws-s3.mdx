...
<Callout type="warning">  
If the connection fails, review [IP Allowlisting](/docs/whitelist-ip) and allow the required Lamatic and Cloudflare ranges.
</Callout>
---
...
- If the connection fails, review [IP Allowlisting](/docs/whitelist-ip) and confirm the required Lamatic and Cloudflare ranges are allowed.
