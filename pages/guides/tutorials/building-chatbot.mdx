...
4. **Add a Text LLM Node**  
   In the next node, select **Text LLM** and choose **Gemini**.  
...
6. **Generate Chat Response**  
   In the **Chat Response** node, add the generated response from the **Text LLM** node by clicking the appropriate option.
...
![building-chatbot.png](./img/building-chatbot/deploy.png)
...
![building-chatbot.png](./img/building-chatbot/chatbot-share.png)
