...
- **Learn about Projects**: Read [Project Settings](/docs/workspace-setup/studio-project) for detailed configuration
- **Set up Authentication**: Configure [API Keys](/docs/workspace-setup/studio-keys) for integrations
