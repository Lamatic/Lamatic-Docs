...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Dinner Technologies Inc., 720 SE 8th St Fort Lauderdale, FL, 33316.
...
- __Website__ refers to Lamatic.ai, accessible from [https://lamatic.ai](https://lamatic.ai)
...
- Performance Cookies__

   Type: Performance Cookies

   Administered by: Us

   Purpose:These cookies (the Lamatic.ai uses Posthog) allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site. If you do not allow these cookies we will not know when you have visited our site and will not be able to monitor its performance.
...
- By email: hello@lamatic.ai


- By visiting this page on our website: [https://support.lamatic.ai/](https://support.lamatic.ai/)
