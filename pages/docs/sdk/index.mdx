...
Once your Flows are built and deployed, the SDK is the easiest way to call them from TypeScript, Node.js, or browser-based apps.

The [Lamatic SDK](https://github.com/Lamatic/lamatic-sdk) provides a simple way to interact with the Lamatic AI platform, allowing you to execute Flows and integrate AI capabilities into your applications.
...
One of the main functions of the SDK is to execute Flows that you've created on the Lamatic platform.
...
Lamatic also provides a Python SDK (`pip install lamatic`) for executing flows from Python applications, with both sync and async methods and status checking with polling.

For detailed information, installation instructions, and code examples, see the [Python SDK documentation](/docs/sdk/python).
...
For detailed information, installation instructions, code examples, and API reference, see the [Go SDK documentation](/docs/sdk/go).
