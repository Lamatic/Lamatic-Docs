...
### API Key
A secret key used to authenticate requests to your Lamatic project. You include it in the `Authorization` header when making API calls. See [Authentication with API Keys](/docs/workspace-setup/studio-keys) for more details.
