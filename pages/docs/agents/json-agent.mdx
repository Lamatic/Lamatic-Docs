...
|---------------------------|-------------------------------------------------------|---------------------------------------|
| **Generative Model Name** | Selects the AI model for structured JSON output.      | `Mistral-Large-2402`                 |
| **Prompt Template**       | Defines instructions for generating structured data.  | `"Generate a structured JSON on travel destinations"` |
| **System Prompt**         | Guides the AI in producing role-specific responses.   | `"You are an expert data formatter"` |
