---
title: Airtable Node
description: The Airtable Node automates data synchronization and manipulation with Airtable bases, enabling both trigger-based workflows and action-based operations for comprehensive Airtable integration.
type: Apps
order: 10
---
...
<NodeOverview slug="airtable-node" type="apps" />
...
<NodeTypeInfo
  ...
  eventTrigger={true}
  action={true}
  description="This node supports both Event Trigger and Action modes for comprehensive Airtable integration."
/>
