...
If your MySQL instance is protected by network rules, review [IP Allowlisting](/docs/ips) before testing the connection.
...
| **Problem** | **Solution** |
|-------------|---------------|
| **Connection refused** | Check host, port, and firewall settings. See [IP Allowlisting](/docs/ips). |
