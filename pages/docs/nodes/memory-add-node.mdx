...
description: The Memory Add Node enables storing and managing contextual information for users and sessions, allowing for persistent data storage within flow
type: Data
order: 9
---
...
<NodeOverview slug="memory-add-node"/>
