...
1. Customizable Expiry & Retention: Define how long contextual information is retained before expiration.
1. Fine-Grained Access Control: Restrict memory access based on user roles and permissions.
...
1. **Access the Memory Store:** Navigate to Context and select Memory Store.
    ![img.png](./img/memory-store-view.png)
