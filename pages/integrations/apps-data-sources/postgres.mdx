...
| **Network Connectivity**    | Check firewall settings and review [IP Allowlisting](/docs/ips)     |
...
6. If the connection fails, review [IP Allowlisting](/docs/ips) and confirm the required Lamatic and Cloudflare ranges are allowed.
