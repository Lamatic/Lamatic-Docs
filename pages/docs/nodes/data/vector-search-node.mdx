...
description: The Vector Search Node performs semantic search operations on vector databases to find similar content.
type: Data
order: 9
---
...
| **Limit**                | Number of results to return. Set to `0` to return all records.                                        | 3                            |
