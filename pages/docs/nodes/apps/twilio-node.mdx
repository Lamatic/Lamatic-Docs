---
title: Twilio Node
description: The Twilio Node provides communication automation capabilities through SMS, voice calls, and WhatsApp messaging, enabling multi-channel communication within workflows.
type: Apps
order: 5
---
...
<NodeOverview slug="twilio-node" type="apps" />
...
![twilio.png](../img/twilio/twilio.png)

<NodeTypeInfo
  batchTrigger={false}
  eventTrigger={false}
  action={true}
  description="This node is an Action node that provides communication automation capabilities for SMS, voice calls, and WhatsApp messaging."
/>
