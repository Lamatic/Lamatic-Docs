...
1. Add a Supervisor Agent Node to your canvas and connect it to the API Trigger Node.
...
4. Add system prompts to guide the supervisor:
   ...
   The ideal order of using the agents is:
   PARSER -> EVALUATOR
...
5. Set the generative model to `o3-mini` for efficient processing.
6. Set maximum iterations to 5 to allow sufficient cycles for completion.
