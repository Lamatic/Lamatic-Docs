...
<Tabs items={['Engineering', 'Go-to-Market']}>
  <Tab>
  ...
  <Tab>
    <Accordion type="single" collapsible>
      ...
      <AccordionItem value="support-engineer">
        <AccordionTrigger className="career-accordion-trigger">Founding Support Engineer</AccordionTrigger>
        <AccordionContent>
          **Job Description:**

          Lamatic.ai is seeking a highly motivated and customer-focused **Founding Support Engineer**. In this role, you will provide technical support to developers and customers, troubleshoot issues, and help ensure a seamless experience with our products. You will work closely with the engineering, product, and developer relations teams to improve our support processes and enhance user satisfaction.
