---
title: Variable Node
description: The Variable Node allows users to define and manage variables for storing and manipulating data within workflows.
type: Logic
order: 6
---
...
![variable.png](../img/variable/variable.webp)
...
This node is an **Action** node that defines and manages variables for data storage and manipulation within workflows.
