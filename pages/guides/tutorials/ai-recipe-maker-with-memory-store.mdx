...
3. Configure your API:
   ...
   - Set response type to "Real-time"
     ![Flow API Schema](./img/recipe-gen-with-memory/api-schema.png)
...
6. Configure the Generative model:
   ...
   - Choose "gpt-4o-mini" as your Model
     ![Flow API Schema](./img/recipe-gen-with-memory/memory-node1.png)
...
5. Configure the Embedding model:
   - Select your "Open AI" credentials
   - Choose "text-embeddin-3-small" as your Model
     ![Flow API Schema](./img/recipe-gen-with-memory/memory-node2.png)

### 5. Adding AI LLM

1. Click the + icon to add a new node
2. Choose "Text LLM"
   ![Node Text Gen](./img/recipe-gen-with-memory/text-gen-node1.png)
...
- You can add variables using the "Add Variable" button
  ![Node Text Gen Config](./img/recipe-gen-with-memory/text-gen-node2.png)

5. Under Addition Properties, Add output from Memory Retrieve node in **Memories**

### 6. Configuring the reponse

1. Click the API response node
   ![Flow Deploy](./img/recipe-gen-with-memory/response-node.png)
