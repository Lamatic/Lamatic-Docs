...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3" href="https://studio.lamatic.ai/_?templateSlug=topic-insights" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=topic-insights" target="_blank">Add to Lamatic</a>
  </Button>
</Callout>
</div>
