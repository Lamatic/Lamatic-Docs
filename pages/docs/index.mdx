...
- [Test](/docs/Test) \- Tools to test and debug your flow and application in development and before Deployments.
...
- [Marketplace↗](https://marketplace.lamat.ai) \- Perfect your workflow with powerful apps, models and templates. Any workflow is possible with a boost from the app marketplace..
...
- [Widgets](/docs/widgets) \- Drop In AI Components like Search and Chat in your application with few lines of code.

### 🚀 Deploy
Monitor, Manage and Optimize your AI applications.

- [GraphQL API](/docs/GraphQL) \- Integrate flow / Agents in your applicaiton with Federated and modular GraphQL API with automatically generated Docs.
- [Edge Deployments](/docs/Edge-Deployments) \- Deploy and manage your agents and workflows on the Edge.
