...
Unlock the power of customization with the **Code IDE** in Lamatic flows. This feature allows you to write concise scripts or execute JavaScript directly within your flow. Whether you need to transform input data, manipulate output data, or perform preprocessing tasks, the Code IDE gives you flexible control over your workflow logic.

Use the variable editor for plain, structured input. Heading formatting support has been removed from the variable editor component.
