...
category: Beginner
order: 1
tags: ["Gemini", "Text Generator", "API"]
...
1. Select "API Request" under the interface options
   ![Flow API](./img/get-started/api-flow.png)
...
1. Select variables from your Text Generator Node
...
1. Your API is now ready to be integrated into Node.js or Python applications
1. Your flow will run on Lamatic's global edge network for fast, scalable performance
