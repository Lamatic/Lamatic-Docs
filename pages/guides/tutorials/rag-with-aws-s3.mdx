...
3. Choose **S3 Node** as the trigger. Refer to [S3 Node setup instructions](https://lamatic.ai/docs/integrations/aws-s3).
...
2. Configure the node:
   ...
   ![Overview](./img/aws-s3/file-extract.png)
...
1. Use a **Logic Node** to extract chunked text:
   ...
   ![RAG Chunking](./img/aws-s3/rag-s3-2.png)
---
...
3. Integrate the chat widget into your website:
   ...
   ![chatbot-share](./img/aws-s3/chatbot-share.png)
