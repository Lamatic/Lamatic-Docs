---
title: Vector Store
description: Vector Store in Lamatic Studio
---
...
> **Pro Tip**: Quickly deploy a Weaviate instance and start storing vectors in minutes, without worrying about infrastructure management.
