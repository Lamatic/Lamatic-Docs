...
As data flows through the Lamatic.ai mapping system, you can optionally enrich it with additional metadata properties generated from AI services. This could include classifications, named entity extractions, key phrase detection, and more.

Lamatic.ai also allows you to apply data governance policies during mapping to enforce rules, data quality constraints, data masking, and lineage tracking.
