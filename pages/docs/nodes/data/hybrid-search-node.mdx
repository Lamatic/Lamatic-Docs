...
| **Certainty**                           | t's the distance score into a value between 0 <= certainty <= 1, where 1 would represent identical vectors and 0 would represent opposite vectors.                                                                   | 0.7                          |
