...
<Callout type="warning">
  **Important:** Your database user must have permissions to access the relevant
  schemas and tables. If your database is behind a firewall or IP allowlist,
  see [IP Allowlisting](/docs/whitelist-ip).
</Callout>
...
| **Network Connectivity**    | Check firewall settings and review [IP Allowlisting](/docs/whitelist-ip)     |
...
6. If the connection fails, review [IP Allowlisting](/docs/whitelist-ip) and confirm the required Lamatic and Cloudflare ranges are allowed.
