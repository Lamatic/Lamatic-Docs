...
<details> 
  ...
  1. **Dynamic Query Handling**: Supports dynamic query generation using variables (e.g., `{{triggerNode_1.output.topic}}`) for flexible search and data retrieval. 
...
nodes:
  - nodeId: RAGNode_666
    ...
    values:
      ...
      queryField: "{{triggerNode_1.output.topic}}"
      limit: "3"
      certainty: "0.7"
      filters: |-
        {
