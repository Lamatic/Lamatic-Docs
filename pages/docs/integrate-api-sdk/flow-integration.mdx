...
Replace `<FLOW_ID>`, `<PROJECT_ID>`, and the endpoint with the values from the Connect modal. Get your API key from **Studio → Settings → API Keys** or the **Get API Key** link in the modal. See [API Overview](/docs/integrate-api-sdk/api-overview) and [API Keys](/docs/api-integration/api-key) for more.
...
- For more API details, see [API Overview](/docs/integrate-api-sdk/api-overview) and [Integration Guide](/docs/api-integration/integration-guide).
