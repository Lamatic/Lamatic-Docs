---
title: Architecture
description: How does Lamatic work?
---
...
![Lamatic Architecture](./concepts/img/ai-middleware.png)
...
<Steps>
    ...
    ### Trigger the Flow with GraphQL API, widgets or webhooks
...
- **Schema** - Specify the Schema of API query input and responses based on your data structure.
- **Logs** - Log all incoming requests and query them for analysis.
- **Reports** - Dashboard and Charts for your execution
- **Evals** - Test Flows and prompts
...
- **Logic** - Set up failover/fallback/retry/ Test models.
- **Predictions** - Cost predictions based on consumption.
- **Keys** - Manage your model subscriptions in one place.
...
<iframe width="768" height="496" src="https://miro.com/app/live-embed/uXjVKlDyfYc=/?focusWidget=3458764598245708486&embedMode=view_only_without_ui&embedId=792982201736" frameborder="0" scrolling="no" allow="fullscreen; clipboard-read; clipboard-write" allowfullscreen></iframe>
