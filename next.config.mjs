...
const permanentRedirects = [
  ...
  ["/docs/studio-keys", "/docs/workspace-setup/studio-keys"],
  ["/docs/studio-overview", "/docs/workspace-setup/studio-overview"],
  ["/docs/studio-project", "/docs/workspace-setup/studio-project"],
  ["/docs/studio-role-based-access", "/docs/workspace-setup/studio-role-based-access"],
  ["/docs/studio-tags", "/docs/workspace-setup/studio-tags"],
  ["/docs/studio-variables-and-secrets", "/docs/workspace-setup/studio-variables-and-secrets"],
  ["/docs/studio/project", "/docs/workspace-setup/studio-project"],
  ["/docs/flow-editor", "/docs/build-first-flow/flow-editor"],
  ["/docs/add-variables", "/docs/build-first-flow/add-variables"],
  ["/docs/configure-flow-yaml", "/docs/build-first-flow/configure-flow-yaml"],
  ["/docs/flow-ai-assistant", "/docs/build-first-flow/flow-ai-assistant"],
  ["/docs/add-sticky-notes", "/docs/build-first-flow/add-sticky-notes"],
  ["/docs/tests", "/docs/build-first-flow/tests"],
  ["/docs/tests/:path*", "/docs/build-first-flow/tests/:path*"],
  ["/docs/deployments", "/docs/deploy-section/deployments"],
  ["/docs/environment", "/docs/deploy-section/environment"],
  ["/docs/cache", "/docs/deploy-section/cache"],
  ["/docs/version-control", "/docs/deploy-section/version-control"],
  ["/docs/jobs", "/docs/deploy-section/jobs"],
  ["/docs/logs", "/docs/monitor-improve/logs"],
  ["/docs/reports", "/docs/monitor-improve/reports"],
  ["/docs/langfuse-integration", "/docs/monitor-improve/langfuse-integration"],
