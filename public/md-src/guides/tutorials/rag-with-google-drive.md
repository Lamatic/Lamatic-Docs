...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3 mx-2" href="https://studio.lamatic.ai/_?templateSlug=vectorize-google-drive" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=vectorize-google-drive" target="_blank">Add Flow 1 to Lamatic</a>
  </Button>
  <Button variant="destructive" className="mt-3 mx-2" href="https://studio.lamatic.ai/_?templateSlug=rag-chatbot" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=rag-chatbot" target="_blank">Add Flow 2 to Lamatic</a>
  </Button>
</div>
