...
<div className="mt-4 mb-4">
  ...
  <Button variant="destructive" className="mt-3 mx-2" href="https://studio.lamatic.ai/_?templateSlug=vectorise-s3" size="sm" asChild>
    <a href="https://studio.lamatic.ai/_?templateSlug=vectorise-s3" target="_blank">Add Flow 1 to Lamatic</a>
  </Button>
...
![Overview](./img/aws-s3/s3.png)

---

## What You'll Build

- Utilize **Lamatic.ai Studio** for building flow.
...
3. Click on new flow.
4. Choose **S3 Node** as the trigger. Refer to [S3 Node setup instructions](https://lamatic.ai/integrations/aws-s3).
...
1. Add a **Vector Node** and configure it:
   ...
   ![RAG Chunking](./img/aws-s3/s3-vectorize.png)
