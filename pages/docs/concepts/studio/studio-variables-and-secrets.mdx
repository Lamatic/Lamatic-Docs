...
description: "Store API keys and secrets securely for use across Lamatic flows."
sidebar_label: "Variables & Secrets"
description: Store and manage variables, API keys, and secrets securely in Lamatic.ai and reference them across your flows without exposing values.
---
